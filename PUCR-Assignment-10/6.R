...
rest = list(classify(geneExpe, "Class", "classif.svm", list(mlr::acc, auc, f1, mcc)),
            classify(geneExpe, "Class", "classif.randomForest", list(mlr::acc, auc, f1, mcc)),
            classify(geneExpe, "Class", "classif.naiveBayes", list(mlr::acc, auc, f1, mcc)),
            classify(geneExpe, "Class", "classif.kknn", list(mlr::acc, auc, f1, mcc)),
            classify(geneExpe, "Class", "classif.gbm", list(mlr::acc, auc, f1, mcc))
)

print(c("acc" = "classif.kknn", "auc" = "classif.gbm", "f1" = "classif.naiveBayes", "mcc" = "classif.kknn"))
