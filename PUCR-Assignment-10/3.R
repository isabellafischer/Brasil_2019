...
print(classify(clinicData, "Class", "classif.svm", list(mlr::acc, auc, f1, mcc) ))
print(classify(clinicData, "Class", "classif.randomForest", list(mlr::acc, auc, f1, mcc) ))
print(classify(clinicData, "Class", "classif.naiveBayes", list(mlr::acc, auc, f1, mcc) ))
print(classify(clinicData, "Class", "classif.kknn", list(mlr::acc, auc, f1, mcc) ))
print(classify(clinicData, "Class", "classif.gbm", list(mlr::acc, auc, f1, mcc) ))
